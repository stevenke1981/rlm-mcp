...
|---------|------|-------------|
| Prompt templates | [`agent-prompt-templates.md`](agent-prompt-templates.md) | Copy-paste agent prompts for the RLM loop |
| Log diagnosis | [`fixtures/log-diagnosis/`](fixtures/log-diagnosis/) | ERROR lines in a multi-file mini corpus |
| Multi-document research | [`multi-document-research.md`](multi-document-research.md) | BM25 ranking + parallel map/reduce |
