...
#   $env:RLM_VERSION = "v0.1.1"; .\packaging\windows\install.ps1
...
Write-Host ""
Write-Host "Installed rlm-mcp $Version -> $InstallDir\rlm-mcp.exe" -ForegroundColor Green
Write-Host "MCP command: [\"$InstallDir\rlm-mcp.exe\"]"
